...
# API URLs - configurable via environment variables for production deployment
API_BASE = os.getenv("API_BASE_URL", "http://127.0.0.1:8000")
API_URL = f"{API_BASE}/api/detection"
VIDEO_FRAME_API = f"{API_BASE}/api/video-frame"
CAMERA_MODE_API = f"{API_BASE}/api/camera/mode"
CAMERA_INDEX = 0
